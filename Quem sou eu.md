...
- Como entrei em Ciberseguraça?:
  
   - Essa é uma pergunta comum de se fazer para alguém que é ou pretende entrar na área,
     e o meu motivo é bem simples na verdade, e começou com um pensamento de:
     "cara... por que eu não posso me tornar um hacker?" desde então eu venho estudando
     diariamente.

- Minha Personalidade:

   - Sou um cara introvertido/seletivo, não sou de ser o centro das atenções. Gosto mais
     de atuar nos "bastidores" e se necessário assumir a "frente do time".
     Sou focado e determinado quanto tenho motivo real para aprender/fazer algo.
     Não sou de fazer bagunça ou muito menos causar entrigas desnecessárias.
     Priorizo a Ética da profissão("tudo autorizado/no escopo ou nada").

- Estilo de aprendizado:
  
   - Gosto mais de buscar informações por conta própria do que depender de uma
     "verdade universal" (autodidata-investigativo), mas isso naõ quer dizer que eu
     recuse aprender com outras pessoas(só não assumo tudo como verdade imediata).
     Sou mais direcioando a necessidade do que ficar aprendendo um monte de coisas
...
- Pontos fortes:
   ...
   - Sou focado quando o objetivo é claro
   - Aprendo quando o grupo também aprende(ensinar)
   - Aprendo com os outros(ser ensinado)
   - Gosto de troca de ideas("por que 'x' se temos 'y'?")
   - Posso assumir a liderença se necessário(mas com um contexto claro antes)
   - Assumo que não sei de tudo e que estou disposto a aprender
